				...
				<div className="flex flex-col items-center gap-6 border-border border-b pb-10 md:flex-row md:items-start md:gap-8">
					...
					<div className="w-full flex-1 text-center md:text-left">
						...
						<div className="flex flex-col gap-3 sm:flex-row">
							<button
								className="w-full bg-primary px-6 py-2.5 font-bold text-[10px] text-primary-foreground uppercase tracking-widest transition-all hover:bg-neutral-800 disabled:opacity-50 sm:w-auto"
								type="button"
								onClick={() => fileInputRef.current?.click()}
