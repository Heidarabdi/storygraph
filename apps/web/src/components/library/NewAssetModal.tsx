					...
					<div className="grid gap-6 py-8">
						...
						<div className="space-y-3">
							...
							<Textarea
								...
								className="resize-none rounded-none border-border border-x-0 border-t-0 border-b bg-transparent px-0 py-0 pb-1 text-sm shadow-none [field-sizing:initial] focus-visible:border-primary focus-visible:ring-0"
							/>
						</div>
