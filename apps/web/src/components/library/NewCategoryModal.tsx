							...
							<div className="grid grid-cols-5 gap-2">
								{CATEGORY_ICONS.map((item) => (
									<button
										...
										className={`flex h-12 items-center justify-center border transition-all ${
											selectedIcon === item.id
												? "border-primary bg-primary text-primary-foreground shadow-lg"
												: "border-border/50 bg-muted/10 text-muted-foreground hover:bg-muted/30 hover:text-primary"
										}`}
										title={item.label}
									>
										<item.icon size={18} />
